                    ...
                    <Segment.Group horizontal>
                        ...
                        <Divider />
                                <Table basic='very' celled >
                                            ...
                                            <Table.Cell>{paymentIssue.repairsRequisitionPayment.requestedBy.personnelDetails.firstName} &nbsp; {paymentIssue.repairsRequisitionPayment.requestedBy.personnelDetails.lastName}</Table.Cell>
                                                </Table.Row>
                                                <Table.Row>
                                        ...
                                        <Table.Cell>{paymentIssue.repairsRequisitionPayment.vehicleToBeRepaired.registrationNumber}</Table.Cell>
                                        </Table.Row>
                                                <Table.Row>
                                        <Table.Cell><b>Details </b></Table.Cell>
                                        <Table.Cell>{paymentIssue.repairsRequisitionPayment.otherDetails}</Table.Cell>
                                        </Table.Row>        
                                            </Table.Body>
                                        </Table>   
                                        <Divider /> 
...
export default graphql(ADDPAYMENTDETAILSMUTATION, {name:'addPaymentDetails'})  (ReportRepairsRequisitionsCash);
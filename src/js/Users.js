              ...
              {this.props.userFeed.userFeed.map(user => (
                <Table.Row>
                  ...
                  <Dropdown
                    ...
                    selection
                    options={options}
                    onChange={this._handleChange.bind(this, user.id)}
                  />
                    
                  </Table.Cell>
                  <Table.Cell>{user.email}</Table.Cell>
                  <Table.Cell>{(user.locked) ? <Checkbox onChange={()=>this._changeUser(user.id)} /> : <Checkbox defaultChecked onChange={()=>this._changeUser(user.id)}/>}</Table.Cell>

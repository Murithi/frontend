...
class RepairsRequisitionsInititated extends Component {
    ...
    render() { 
        ...
        const timeoutMessage = (
          ...
          if (this.props.requisitionFeed.initiatedRepairsRequisitionsFeed === undefined ||this.props.requisitionFeed.initiatedRepairsRequisitionsFeed === 0) {
        ...
        return (
            ...
            <Table celled selectable>
                ...
                {
                    this.props.requisitionFeed.initiatedRepairsRequisitionsFeed.map(request => (
                        <Table.Row>
                  ...
                  {(() => {
                    if (request.approvalStatus) {
                      ...
                      if (this.props.userDetails.me.role === 'DIRECTOR') {
                        return (
                          <Link to={`/repairsrequisitions/approve/${request.id}`}>
                            Approve

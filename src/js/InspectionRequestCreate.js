...
import Inspections_Requisition_Feed_Query from './queries/fetchInspectionRequests';import { argumentsObjectFromField } from 'apollo-utilities';
...
class InspectionRequestCreate extends Component {
    ...
    _createVehicleInspection = async () => {
        ...
        await this.props.createInspection({
            ...
            refetchQueries: [{query: Inspections_Requisition_Feed_Query}]
        })

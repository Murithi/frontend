...
mutation issueMaterial(
    $itemId:ID!, $balBefore:Int!, $unitsIssued:Int!, 
  $StoreBalId:ID!, $dateOfTran:DateTime!, $materialsIssuedTo:String!
){
  materialIssue(
    itemId:$itemId
    balBefore:$balBefore
    ...
    materialsIssuedTo:$materialsIssuedTo

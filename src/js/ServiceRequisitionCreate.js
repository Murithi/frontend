...
class ServiceRequisitionCreate extends Component {
    ...
    validate = () => { 
        ...
        if (!this.state.approxCostOFService) errors.approxCostOFService = "Can't be blank";
        ...
        <Grid.Column style={{ maxWidth: 600 }}>
            <Header as="h2" color="green" textAlign="center">
                ...
                <Form.Field error={!!errors.approxCostOFService}>
                    ...
                    type='number'                
                    onChange={e => this.setState({ approxCostOFService: e.target.value })}
                    />
                    {errors.approxCostOFService && <InlineError text={errors.approxCostOFService} />}
                            </Form.Field>
    ...
    _createServiceRequisition=async ()=>{ 
        ...
        await this.props.createServiceRequisition({
            ...
            refetchQueries: [{query: Service_Requisition_Feed_Query}]
        });
...
export default compose(    
    ...
    graphql(CREATESERVICEREQUISITIONMUTATION, {name:'createServiceRequisition'})

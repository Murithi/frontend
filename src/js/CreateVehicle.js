...
const options = [
  { id: 'cjefmixdr5vf101044399y239', text: 'Kewa East Africa', value: 'Kewa East Africa' },
  { id: 'cjefs1f1gib5001041gl94dt5', text: 'County Engineering', value: 'County Engineering' }
];
...
`;
export default graphql(CREATEVEHICLEMUTATION, { name: 'createVehicle' })(CreateVehicle);

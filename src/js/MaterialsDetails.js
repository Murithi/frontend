            ...
            <Grid textAlign="center" style={{ height: '100%' }} verticalAlign="middle">
                <Grid.Column style={{ maxWidth: 1600 }}>
                    ...
                    <b>Cost Per Unit:</b> {materialsCosting.costPerUnit} 
                        ...
                        <Divider />
                    <React.Fragment>
                    <b>Value of {materialsCosting.materialName} in Store:</b> {materialsCosting.costPerUnit * materialsCosting.balance.balance} 
                    </React.Fragment>
                        <Divider /> 
                        <React.Fragment>
                    ...
                    <Segment.Group horizontal >
                        ...
                        <Header as="h5" color="green" textAlign="center">
                                {materialsCosting.materialName} Recieved
                                        </Header>
                ...
                <Menu floated="right" pagination>
                  ...
                  <Menu.Item as="a" icon>
                    <Icon name="chevron right" />
                        ...
                        <Segment>
                        <Header as="h5" color="green" textAlign="center">
                                {materialsCosting.materialName} Issued
                                        </Header>
                        <Table celled selectable>
                                <Table.Header>

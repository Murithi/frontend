...
class MaterialRequisitionsReport extends Component {
    ...
    render() {
        ...
        const { paymentIssue } = this.props.paymentDetails
        if (paymentIssue.length === 0) {
                    ...
                    <Segment.Group horizontal>
                        ...
                        <Divider />
                                <Table basic='very' celled >
                                            ...
                                            <Table.Cell>{paymentIssue.requestedMaterialsPayment.requestedBy.personnelDetails.firstName} &nbsp; {paymentIssue.requestedMaterialsPayment.requestedBy.personnelDetails.lastName}</Table.Cell>
                                                </Table.Row>
                                                <Table.Row>
                                        ...
                                        <Table.Cell>{paymentIssue.requestedMaterialsPayment.materialType.materialName}</Table.Cell>
                                        </Table.Row>
                                                <Table.Row>
                                        <Table.Cell><b>Details </b></Table.Cell>
                                        <Table.Cell>{paymentIssue.requestedMaterialsPayment.otherDetails}</Table.Cell>
                                        </Table.Row>        
                                            </Table.Body>
                                        </Table>   
                                        <Divider /> 

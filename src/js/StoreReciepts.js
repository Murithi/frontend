...
class StoreReciepts extends Component {
    ...
    _addReceipt = async () => {
        ...
        const balBefore = this.props.materialsCostFeed.materialsCostingFeed[0].balance.balance
        
        await this.props.addReceipt({
            variables: {
                itemId, balBefore, unitsRecieved,
            dateOfTran, materialsRecievedFrom,
            StoreBalId, deliveryNote
            }
        })
...
mutation addMaterialsRecieved(
  $itemId:ID!, $balBefore:Int!, $unitsRecieved:Int!, 
  ...
  materialReciept(
    itemId:$itemId
    balBefore:$balBefore
    unitsRecieved:$unitsRecieved
    dateOfTran:$dateOfTran
    materialsRecievedFrom:$materialsRecievedFrom

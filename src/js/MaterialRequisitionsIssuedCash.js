        ...
        return ( 
            ...
            <Header as="h4" color="green" textAlign="center">
                ...
                <Table.Row>
                  ...
                  if (request.requestedMaterialsPayment !== null) {
                    return (
                            
                      <Table.Row>
                        <Table.Cell>{request.requestedMaterialsPayment.materialType.materialName}</Table.Cell>
                        <Table.Cell>{request.requestedMaterialsPayment.requestedBy.personnelDetails.firstName}  {request.requestedMaterialsPayment.requestedBy.personnelDetails.lastName}</Table.Cell>
                        <Table.Cell>{request.requestedMaterialsPayment.otherDetails}</Table.Cell>
